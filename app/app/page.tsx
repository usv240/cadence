      ...
      <div className="mx-auto max-w-[1440px]">
        <header className="relative flex items-center justify-between gap-2 border-b border-[#dbe5de] pb-3 sm:gap-3 sm:pb-4">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
            ...
            <button type="button" onClick={() => setShowEyeGazeSetup(true)} aria-pressed={isEyeGazeActive} aria-label={isEyeGazeActive ? "Eye-gaze focus is on. Open controls." : "Set up eye-gaze focus"} className={`grid h-12 w-12 shrink-0 place-items-center rounded-full border text-lg font-bold transition focus:outline-none focus:ring-4 focus:ring-[#9fdfbd] sm:h-14 sm:w-14 ${isEyeGazeActive ? "border-[#1f7a57] bg-[#e3f4eb] text-[#176746]" : "border-[#cdd9d2] bg-white text-[#315a4b] hover:bg-[#edf5ef]"}`}><svg aria-hidden="true" viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 12s3.5-6 9.5-6 9.5 6 9.5 6-3.5 6-9.5 6-9.5-6-9.5-6Z" /><circle cx="12" cy="12" r="2.75" /></svg><span className="sr-only">{isEyeGazeActive ? "Gaze on" : "Eye gaze"}</span></button>
